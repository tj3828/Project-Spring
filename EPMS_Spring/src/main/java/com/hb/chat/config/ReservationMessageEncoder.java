	...
	public String encode(ReservationVO vo) throws EncodeException {
	    ...
	    Json.createGenerator(writer)
	            .writeStartObject()
	              ...
	              .write("r_from", vo.getR_from().substring(2))
	              .write("r_to", vo.getR_to().substring(2))
	              .write("r_request", vo.getR_request().substring(2))
	              ...
	              .write("r_lastDate", vo.getR_lastDate().substring(2))
