			...
			<div class="box">
				<div class="content" style="display: flex;">
					<div class="main_left" style="width: 50%; ">
						<h1 style="color: #F3C209; font-size: 5vmin; text-align: left;">간편예약 서비스</h1>
						...
						<h5 style="color: red; text-align: left; margin-top: 20px;">*로그인 후에 이용해주세요.</h5>
						<h5 style="color: red; text-align: left; bottom:0px; ">*처음 이용하시는 분은 이용안내를 확인하세요.</h5>
					</div>
					<div class="main_right" style="width: 50%; padding-left: 10%; align-self: center;">
						<input type="text" class="form-control" placeholder="주소를 입력하세요." id="keyword" name="keyword" value="" style="width:100%; margin-bottom: 1rem; display:unset;">
							...
							<tbody>
								<%-- <c:forEach var="list" items="${list}" begin="0" end="${list.size()}"> --%>
									<tr>
										...
										<td>서울특별시 관악구 서림동 11111</td>
									</tr>
									<tr>
										<td>서울특별시 강남구 대치동 11121</td>
									</tr>
									<tr>
										<td>서울특별시 강남구 대치동 11121</td>
									</tr>
						...
						<ul class="pagination justify-content-center">
							...
							<%-- <c:forEach var="i" begin="${paging.startPage}" end="${paging.endPage}" step="1">
								<c:choose>
									...
									<c:otherwise> --%>
										<li class='page-item'><a href='../freeboard/freeboard.do?pageNum=' class="page-link"><span>1</span><span class='sr-only'>1</span></a></li>
									<%-- </c:otherwise>
								</c:choose>
							</c:forEach> --%>
							<%-- <c:choose>
								...
								<c:otherwise> --%>
									<li class='page-item'><a href='../freeboard/freeboard.do?pageNum=' class="page-link" aria-label='Next'><span aria-hidden='true'>&gt;</span></a></li>
								<%-- </c:otherwise>
							</c:choose> --%>
							<%-- <c:choose>
